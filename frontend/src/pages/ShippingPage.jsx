...
import { shipping, brand } from "../mock/mock";
import {
  ArrowRight,
  Truck,
  DollarSign,
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {shipping.highlights.map((h, i) => {
              ...
              return (
                <div
                  key={h.title}
                  className="bg-white rounded-2xl p-7 border border-stone-200 hover:border-sage hover:shadow-xl hover:shadow-forest/5 transition-all duration-300 hover:-translate-y-1"
                >
                  <div className="h-12 w-12 rounded-xl bg-forest text-bone flex items-center justify-center mb-5">
