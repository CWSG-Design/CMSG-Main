...
import { brand, products } from "../mock/mock";
...
export default function QuotePage() {
  ...
  const onSubmit = (e) => {
    ...
    if (!form.name || !form.email || !form.product) {
      toast({ title: "Missing info", description: "Please fill name, email and product." });
      return;
    }
    ...
    setSubmitted(true);
    toast({ title: "Quote request received", description: "Our team will reach out within 1 business day." });
  };
