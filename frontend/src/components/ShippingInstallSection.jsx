  ...
  const cards = [
    {
      ...
      body:
        "Coast-to-coast freight from Mississauga, ON. Enclosed crates, peanut-free packaging, all-inclusive pricing to every province.",
      Icon: Truck,
    ...
    },
    {
      ...
      body:
        "Step-by-step LED channel-letter wiring guide, Canadian Electrical Code references, and instructional videos for your crew.",
      Icon: Wrench,
