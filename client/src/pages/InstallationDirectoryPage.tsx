  ...
  return (
    <main className="bg-cream min-h-screen">
      ...
      <section className="bg-bone border-b border-stone-200">
        <div className="max-w-site mx-auto px-4 lg:px-6 pt-16 pb-12">
      ...
      {/* Map + Sidebar */}
      <section className="max-w-site mx-auto px-4 lg:px-6 py-10">
      ...
      {!isLoading && filtered.length > 0 && (
        <section className="max-w-site mx-auto px-4 lg:px-6 pb-16">
