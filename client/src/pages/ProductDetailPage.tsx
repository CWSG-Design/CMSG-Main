...
const productDetails: Record<string, {
  ...
  "push-through-faux-neon": {
    tagline: "The neon look — without the fragility or power cost.",
    description:
      "Push-through acrylic letters and faux neon LED flex signs replicate the warm glow of traditional neon at a fraction of the operating cost and with none of the fragility. CWS produces push-through acrylic letters routed from aluminum cabinets, and custom-bent LED neon flex signs in any shape or font.",
    specs: [
      { label: "Push-through face", value: "Acrylic, 10mm standard" },
      { label: "Cabinet", value: "0.063\" aluminum, powder coated" },
      { label: "LED neon flex", value: "Silicone-jacketed LED neon, IP67" },
      { label: "Colours", value: "Warm white, cool white, red, blue, green, RGB" },
      { label: "Power", value: "UL-listed 24V LED driver" },
      { label: "Lead time", value: "10 business days from approved artwork" },
    ],
    features: [
      "Replicates neon glow without glass tubes",
      "IP67-rated LED neon flex — outdoor and indoor rated",
      "Dramatically lower energy use vs. traditional neon",
      "No mercury, no fragile glass",
      "Custom shapes and fonts — any design",
      "5-year LED warranty",
    ],
    useCases: ["Bars & restaurants", "Retail window displays", "Event & hospitality", "Instagram-worthy feature walls", "Entertainment venues"],
    relatedSlugs: ["open-face-channel-letters", "face-halo-combination", "3d-printed-signs"],
  },
